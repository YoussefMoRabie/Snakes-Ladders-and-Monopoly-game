...
// check if station Parameters take value before or not
	...
	pOut->PrintMessage("New Station Eleven : Enter The amount of coins needed to  buy the cell ...");
	// Get a StationPrice
	...
	//---------------------------------------------------------------------------
	pOut->PrintMessage("New Station Eleven : Enter The amount of coins needed  to pay fees to the player who owns the cell ...");
	// Get Fees
